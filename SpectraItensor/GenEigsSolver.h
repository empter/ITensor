...
template < typename Scalar,
           int SelectionRule,
           typename OpType>
class GenEigsSolver: public GenEigsBase<Scalar, SelectionRule, OpType>
{
private:
...
public:
    ...
    ///
    GenEigsSolver(OpType const* op, Index nev, Index ncv) :
        GenEigsBase<Scalar, SelectionRule, OpType>(op, nev, ncv)
    {}
};
